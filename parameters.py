...
read_len_list = [75,125,1000,10000]
frag_len_list = [150,200,2000,20000]
...
coverage_list = [2, 5, 10, 20, 25, 30, 30, 30, 40, 50]
pop_list = [8e8] #recommend to keep close to this value
num_single_cell_list = [0,0,1]
...
list_of_rates = [ultrahigh_rates_list, ultralow_rates_list, ultrahigh_rates_list, ultralow_rates_list, ultrahigh_rates_list, ultralow_rates_list,ultralow_rates_list, ultralow_rates_list, ultralow_rates_list, ultralow_rates_list, ultralow_rates_list, ultralow_rates_list]
