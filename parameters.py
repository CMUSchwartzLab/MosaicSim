...
use_leaf_only = False
error_rate_list = [0.0, 0.0, 0.000001, 0.00001, 0.00001, 0.0001, 0.001]
clone_list = [5]
...
coverage_list = [1,2,5,10,20,25,30]
...
ref_coverage = 50 #random.choice(coverage_list)
