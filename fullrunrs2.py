...
os.system("srun -p rs2 --mem-per-cpu 150G -t 7-22:00:00 python3 /home/assrivat/MosaicSim/sim.py; srun -p rs2 -c 128 --mem-per-cpu 2200 -t 8-22:00:00 python3 /home/assrivat/MosaicSim/pipeline/python_pipeline_v1.py {} 1 0 0 128 strelka None delly hg38_no_alt; srun -p rs2 --mem-per-cpu 100G python3 /home/assrivat/MosaicSim/fullAnalysis.py {}".format(randomid, randomid))
